    ...
    return (
        <section className="about" id="about">
            ...
            <div className="about__cv">
                <a href="https://drive.google.com/file/d/1Zwh8KtN5X6i3SDrPELB1yqyEuwNDPOtV/view?usp=sharing" target="_blank" className="btn btn-secondary btn-cv" rel="noreferrer">
